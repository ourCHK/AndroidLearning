 ...
 */
public class TouchEventLearningViewGroupB extends ViewGroup {

    private String TAG = TouchEventLearningViewGroupB.class.getSimpleName();

    public TouchEventLearningViewGroupB(Context context) {
        super(context);
    }

    public TouchEventLearningViewGroupB(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
